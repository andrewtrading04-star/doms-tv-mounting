/**
 * Handy Andy — "Book in 3 Simple Steps" with Interactive Preview, Pricing & Social Proof
 * Self-contained Web Component. Drop in with:
 *   <script src="https://handyandydenver.com/booking-demo-handy.js"></script>
 *   <booking-demo-handy></booking-demo-handy>
 */
class BookingDemoHandy extends HTMLElement {
  constructor() {
    super();
...
customElements.define('booking-demo-handy', BookingDemoHandy);
